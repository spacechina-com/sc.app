...
<div class="page-group">
	<div class="page page-current">
		...
		<div class="row" style="padding:10px;padding-top:0px;">
			...
			<div class="col-33"><a href="<%=request.getContextPath()%>/activities?company_id=${pd.company_id}&goods_id=${pd.goods_id}&batch_id=${pd.batch_id}"></a><div style="position:relative;width:100%;"><span style="position:absolute;bottom:20px;text-align: center;color: #FFFFFF;width:100%;">营销活动</span><img style="width:100%;" src="<%=request.getContextPath()%>/static/images/image2.png" alt=""></div></div>
